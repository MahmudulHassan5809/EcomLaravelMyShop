            ...
            <div class="product-details">
                        ...
                        <div class="swiper-container" data-effect="fade">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="product-details-img-wrap swiper-slide">
                                    <img src="{{asset($productById->image)}}" alt="product" data-swiper-parallax="-10">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                    <div class="product-details-info">
                        <div class="product-details-info-price">{{$productById->price}}</div>
                        <h3 class="product-details-info-title">{{$productById->name}}</h3>
                        ...
                        <form action="{{route('cart.add')}}" method="POST">
                            ...
                            <input type="hidden" name="pdt_id" value="{{$productById->id}}">
