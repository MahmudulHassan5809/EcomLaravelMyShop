                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
                                                <img src="{{asset($pdt->model->image)}}" width="80px" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                            </a>
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input title="Qty" class="email input-text qty text" name="qty" value="{{$pdt->qty}}" type="text" placeholder="1" readonly>
